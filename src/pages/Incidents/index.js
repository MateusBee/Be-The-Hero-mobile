...
function Incidents(){
    ...
    async function loadIncidents(){
        ...
        if(total > 0 && incidents.length === total){ // se já carregou todos os dados não precisa buscar mais informações
            return;
        }
    ...
    return (
        <View style={styles.container}>
            ...
            <FlatList
                ...
                onEndReached={loadIncidents} //é disparada de forma automática quando chegar no final da lista
